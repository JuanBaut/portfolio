...
const MagicCard: React.FC<MagicCardProps> = ({
  ...
  return (
    <div
      ...
      className={cn(
        "relative z-0 h-full w-full rounded-lg p-1",
        "bg-background",
        "bg-[radial-gradient(var(--mask-size)_circle_at_var(--mouse-x)_var(--mouse-y),hsl(var(--primary)),transparent_100%)]",
        className,
      )}
      {...props}
    >
      ...
      {/* Background */}
      <div className={"absolute inset-[2px] -z-20 rounded-md bg-background"} />
    </div>
  );
};
