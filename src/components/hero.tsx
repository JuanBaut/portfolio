...
import { SqrImgContainer } from "./img-container";
...
export default async function Hero() {
  return (
    <LayoutMotion className="w-full py-20 md:py-24 lg:py-32">
      ...
      <div className="max-w-screen-lg md:flex-row mx-auto gap-8 px-4 justify-items-center md:px-6 flex flex-col">
        <SqrImgContainer priority loading="eager" src="portfolio/movies" />
        <div className="flex flex-col justify-center space-y-4 basis-2/3">
          <HeaderMotion />
          ...
          <p className="text-muted md:text-xl gap-2">
            ...
            speak <b>C1 English</b> and <b>Native Spanish</b>
          </p>
