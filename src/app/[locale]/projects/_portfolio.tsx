...
export default function Portfolio() {
  return (
    <Card className="mb-4 border-primary p-2">
      <ProjectTitle name="Portfolio" repository="https://github.com/JuanBaut/portfolio" />

      <p className="pt-2 text-sm text-muted">The website you are currently looking at.</p>
