...
export default function Dotfiles() {
  return (
    <Card className="mb-4 border-primary p-2">
      <ProjectTitle name="Dotfiles" repository="https://github.com/JuanBaut/dotfiles" />

      <p className="pt-2 text-sm text-muted">My personal configuration files used in my dev environment.</p>
